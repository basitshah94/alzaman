...
const PaginatedItems=lazy(() => import('../components/paginatedresults/index'));
        ...
        return(
            <Grid container id='qaseeda'>
                ...
                <Grid xs={12} sm={12}>
                    {/* <Card id="qasaid-header">
                        <Grid container className='row'>
                            <Grid item className='col' xs={1} md={1} sm={1} onClick={this.sortPage}>
                                <b>Written</b>
                                <img src='https://icons.getbootstrap.com/assets/icons/sort-alpha-down.svg' width='17px' height='17px'></img>
                            </Grid>
                            <Grid item className='col' xs={1} md={1} sm={1} onClick={this.sortSinf} >
                                <b>Sinf</b>
                                <img src='https://icons.getbootstrap.com/assets/icons/sort-alpha-down.svg' width='17px' height='17px'></img>
                            </Grid>
                            
                            <Grid item className='col' xs={1} md={1} sm={1} onClick={this.sortSubcat}>
                                <b>Sub Category</b>
                                <img src='https://icons.getbootstrap.com/assets/icons/sort-alpha-down.svg' width='17px' height='17px'></img>
                            </Grid>
                            <Grid item className='col' xs={2} md={2} sm={2} onClick={this.sortCat}>
                                <b>Main Category</b>
                                <img src='https://icons.getbootstrap.com/assets/icons/sort-alpha-down.svg' width='17px' height='17px'></img>
                            </Grid>
                            <Grid item className='col' xs={1} md={1} sm={1} onClick={this.sortLang}>
                                <b>Language</b>
                                <img src='https://icons.getbootstrap.com/assets/icons/sort-alpha-down.svg' width='17px' height='17px'></img>
                            </Grid>
                            <Grid item className='col' xs={5} md={5} sm={5} onClick={this.sortTitle}>
                                <b>Title</b>
                                <img src='https://icons.getbootstrap.com/assets/icons/sort-alpha-down.svg' width='17px' height='17px'></img>
                            </Grid>
                            <Grid item className='col' xs={1} md={1} sm={1} onClick={this.sortBook}>
                                <b>Book</b>
                                <img src='https://icons.getbootstrap.com/assets/icons/sort-alpha-down.svg' width='17px' height='17px'></img>
                            </Grid>
                        </Grid>
                ...
                <Grid item xs={12} sm={12}>
                    ...
                    /> */}
                <Pagination count={Math.ceil(this.props.qasaid.length / 100)} onChange={this.handlePagination} variant="outlined"/>
                </Grid>
            </Grid>
        )
    };
